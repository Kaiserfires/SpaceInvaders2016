...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "JuegoBeta(SI)50usd", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "JuegoBeta(SI)50usd";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "JuegoBeta(SI)50usd", null, { width: 480, height: 432 });
...
class ApplicationMain {
	...
	public static function main () {
		...
		config = {
			...
			build: "42",
			company: "HaxeFlixel",
			file: "JuegoBeta(SI)50usd",
			fps: 60,
			name: "JuegoBeta(SI)50usd",
